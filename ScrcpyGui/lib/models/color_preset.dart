...
class ColorPreset {
  ...
  factory ColorPreset.fromJson(Map<String, dynamic> json) => ColorPreset(
    ...
    background: _hex(json['background'] as String),
    surface: _hex(json['surface'] as String),
    inputFill: _hex(json['inputFill'] as String),
    divider: _hex(json['divider'] as String),
    textPrimary: _hex(json['textPrimary'] as String),
    textSecondary: _hex(json['textSecondary'] as String),
    hover: _hex(json['hover'] as String),
    focus: _hex(json['focus'] as String),
    commandSurface: _hex(json['commandSurface'] as String),
  );
